...
import {
  ...
  MY_CLIENT_PRODUCTION_PLUGINS, MY_CLIENT_RULES, API_URL, HOST_URL, PROD_API_URL, PROD_HOST_URL
} from './constants';
...
const CONSTANTS = {
  ...
  API_URL: PROD ? JSON.stringify(PROD_API_URL) : JSON.stringify(API_URL),
  HOST_URL: PROD ? JSON.stringify(PROD_HOST_URL) : JSON.stringify(HOST_URL),
  PORT: PORT,
